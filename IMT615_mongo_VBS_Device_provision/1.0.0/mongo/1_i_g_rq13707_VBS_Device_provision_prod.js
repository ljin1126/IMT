...
({ 
    ...
    "NUM_OF_LINES" : "5", 
    "DEVICE_UNIT_DEFAULT_PROPERTIES" : {
        "prov_server" : "vdp-httpd.gtm.vonagenetworks.net", 
...
({ 
    ...
    "DEVICE_UNIT_DEFAULT_PROPERTIES" : {
        ...
        "BCM_FIRMWARE_URL2" : "vdp-httpd.gtm.vonagenetworks.net", 
        "BCM_FIRMWARE_URL" : "vdp-httpd.gtm.vonagenetworks.net", 
        "BCM_PROVISION_URL" : "vdp-httpd.gtm.vonagenetworks.net", 
        "BCM_PROVISION_URL2" : "vdp-httpd.gtm.vonagenetworks.net", 
...
// users for Device_provision in the prod database
// db.dropUser("ap_vdp_configserver");

db.createUser(
    {
      user: "ap_vdp_configserver",
      pwd: "ap_vdp_configserver_p1",
      roles: [
